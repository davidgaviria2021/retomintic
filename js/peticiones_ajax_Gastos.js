...
function limpiar_formulario(){
	//if (confirm("Esta seguro que desea limpiar el formulario?")){
		...
		var campoTextoNombre = document.getElementById("nameh");
		var campoTextoFecha = document.getElementById("emailh");
		var campoTextoValor = document.getElementById("ageh");
...
function guardarInformacion(){
	...
	if(!validarCampo($("#name"))){      // con dos condicionales hacemos una validacion para nombre y valor
